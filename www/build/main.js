...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SpecialistServiceProvider; });
...
/*
  ...
  and Angular DI.
*/
var SpecialistServiceProvider = (function () {
    function SpecialistServiceProvider(http) {
        this.http = http;
        this.data = [];
    }
    SpecialistServiceProvider.prototype.load = function () {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DomainServiceProvider; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_http__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map__);
...
/*
  ...
  and Angular DI.
*/
var DomainServiceProvider = (function () {
    function DomainServiceProvider(http) {
        this.http = http;
        console.log('Hello DomainServiceProvider Provider');
    }
    DomainServiceProvider.prototype.load = function () {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]({ 'content-Type': 'application/json' });
        var options = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["d" /* RequestOptions */]({ headers: headers });
        return this.http.get('http://172.16.3.223:8000/domains/', options).map(function (res) { return res.json(); });
    };
    return DomainServiceProvider;
}());
DomainServiceProvider = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["B" /* Injectable */])(),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_http__["b" /* Http */]])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_specialist_service_specialist_service__ = __webpack_require__(194);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__angular_http__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_domain_service_domain_service__ = __webpack_require__(195);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_speciality_service_speciality_service__ = __webpack_require__(264);
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["L" /* NgModule */])({
        ...
        providers: [
            ...
            __WEBPACK_IMPORTED_MODULE_6__providers_specialist_service_specialist_service__["a" /* SpecialistServiceProvider */],
            __WEBPACK_IMPORTED_MODULE_8__providers_domain_service_domain_service__["a" /* DomainServiceProvider */],
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SpecialityServiceProvider; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_http__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map__);
...
/*
  ...
  and Angular DI.
*/
var SpecialityServiceProvider = (function () {
    function SpecialityServiceProvider(http) {
        this.http = http;
        console.log('Hello SpecialityServiceProvider Provider');
    }
    return SpecialityServiceProvider;
}());
SpecialityServiceProvider = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["B" /* Injectable */])(),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_http__["b" /* Http */]])
...
/*
  ...
  and Angular DI.
*/
var RateServiceProvider = (function () {
    function RateServiceProvider(http) {
        this.http = http;
